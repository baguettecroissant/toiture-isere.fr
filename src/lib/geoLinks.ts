/**
 * Geographic proximity linking engine for Isère (38).
...
export function getNearbyCommunes(
  ...
  return allCommunes
    ...
    .map(c => {
      ...
      // Approximate physical distance in km using local projection (45.18°N for Grenoble/Isère)
      // 1 degree of Latitude ≈ 111.1 km
      // 1 degree of Longitude ≈ 111.1 * cos(45.18°) ≈ 78.3 km
      const dLat = (lat - currentLat) * 111.1;
      const dLon = (lon - currentLon) * 78.3;
